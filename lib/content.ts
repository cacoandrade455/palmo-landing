  ...
  pt: {
    ...
    appraiser: {
      ...
      cropNotes: {
        ...
        fumo: "Fumo funciona por integração com as fumageiras: a empresa fomenta insumos e compra a safra — parceria de terra clássica do Sul, com renda média de ~R$46 mil/ha ao produtor (Afubra/CONAB, safra 24/25).",
      ...
      cropFormation: {
        ...
        goiaba: "Goiaba clonal produz a partir de ~1,5–2 anos; produção plena: ~4 anos (Embrapa).",
        abacate: "Do plantio à primeira colheita: ~3–4 anos; produção plena: ~7 anos (Embrapa) — contratos de plantio costumam prever carência.",
        maca: "Do plantio à primeira colheita: ~3–4 anos; produção plena: ~5–6 anos (Epagri/Embrapa) — contratos de plantio costumam prever carência.",
        pessego: "Do plantio à primeira colheita: ~2–3 anos; produção plena: ~4–5 anos (Embrapa).",
      },
    },
    auth: {
      signIn: "Entrar",
  ...
  en: {
    ...
    appraiser: {
      ...
      cropNotes: {
        ...
        fumo: "Tobacco runs on integration with leaf companies: they finance inputs and buy the crop — the South's classic land partnership, averaging ~R$46k/ha in producer income (Afubra/CONAB, 24/25 season).",
      ...
      cropFormation: {
        ...
        goiaba: "Clonal guava bears from ~1.5–2 years; full yield: ~4 years (Embrapa).",
        abacate: "Planting to first harvest: ~3–4 years; full yield: ~7 years (Embrapa) — planting leases usually include a grace period.",
        maca: "Planting to first harvest: ~3–4 years; full yield: ~5–6 years (Epagri/Embrapa) — planting leases usually include a grace period.",
        pessego: "Planting to first harvest: ~2–3 years; full yield: ~4–5 years (Embrapa).",
      },
    },
    auth: {
      signIn: "Sign in",
